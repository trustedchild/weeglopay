...
{
    // dd($nexmoCredentials, $to, $message);
...
{
    // dd($twilioCredentials, $to, $message);
    ...
    $data = array (
        'From' => $twilioCredentials['default_twilio_phone_number'],
        'To' => $to,
    ...
    curl_setopt($x, CURLOPT_USERPWD, "$accountSID:$authToken");
