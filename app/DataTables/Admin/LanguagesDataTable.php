...
class LanguagesDataTable extends DataTable
{
    ...
    public function ajax() //don't use default dataTable() method
    {
        ...
        return datatables()
            ...
            {
                return isset($language->flag) ? '<img src="' . url('public/uploads/languages-flags/' . $language->flag) . '" width="120" height="80">' :
                '<img src="' . url('public/uploads/userPic/default-image.png').'" width="120" height="80">';
            })
