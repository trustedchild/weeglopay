...
return [
    ...
    'home'                 => [
        ...
        'banner'          => [
            'title'      => 'تحويل الأموال البسيط إلى أحبائك',
            'sub-title1' => 'بسيطة ل: أن تكون متكاملة',
            'sub-title2' => 'متعددة المحفظة',
            'sub-title3' => 'متقدم الأمن',
...
                            ليس. يمكن أن تدفع لك مع paypal ، شريط ، 2checkout والعديد من paymentgateway أكثر.',
    ...
    'dashboard'            => [
        'mail-not-sent' => 'لكن الرسائل لا يمكن إرسالها',
        'nav-menu'      => [
            'dashboard'    => 'لوحة القيادة',
            'transactions' => 'المعاملات',
            'send-req'     => 'ارسل طلب',
        ...
        'crypto'        => [
            'send'    => [
                'create'  => [
                    'recipient-address-input-label-text'         => 'عنوان المستلم',
                    'recipient-address-input-placeholder-text-1' => 'أدخل مستلم صالح',
                    'recipient-address-input-placeholder-text-2' => 'عنوان',
                    'address-qr-code-foot-text-1'                => 'فقط أرسل',
                    'amount-warning-text-1'                      => 'يجب أن يكون المبلغ المسحوب / المرسل على الأقل',
                    'amount-warning-text-2'                      => 'يرجى الاحتفاظ على الأقل',
                    'amount-warning-text-3'                      => 'لرسوم الشبكة',
                    'amount-warning-text-4'                      => 'قد تستغرق عمليات التشفير بعض اللحظات',
                    'amount-allowed-decimal-text'                => 'سمحت تصل إلى 8 المنازل العشرية',
                ],
                'confirm' => [
                    'about-to-send-text-1' => 'أنت على وشك الإرسال',
                    'about-to-send-text-2' => 'إلى',
                    'sent-amount'          => 'المبلغ المرسلة',
                    'network-fee'          => 'رسوم الشبكة',
                ],
                'success' => [
                    'sent-successfully' => 'أرسل بنجاح',
                    'amount-added'      => 'سيتم إضافة المبلغ بعد',
            ...
            'receive' => [
                'address-qr-code-head-text'   => 'تلقي عنوان رمز الاستجابة السريعة',
                'address-qr-code-foot-text-1' => 'تلقي فقط',
                'address-qr-code-foot-text-2' => 'إلى هذا العنوان',
                'address-qr-code-foot-text-3' => 'تلقي أي عملة أخرى سوف يؤدي إلى خسارة دائمة',
                'address-input-label-text'    => 'تلقي عنوان',
                'address-input-copy-text'     => 'نسخ',
            ],
            'transactions' => [
            ...
            'preference-disabled' => 'قام مسؤول النظام بتعطيل عملة التشفير',
        ],
    ],
    'express-payment'      => [
        'payment'           => 'دفع',
