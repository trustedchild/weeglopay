...
                            不。他们可以用paypal，条纹，2checkout和更多的paygateway支付给你。',
    ...
    'dashboard'            => [
        ...
        'crypto'        => [
            'send'    => [
                'create'  => [
                    'recipient-address-input-label-text'         => '收件人地址',
                    'recipient-address-input-placeholder-text-1' => '输入有效的收件人',
                    'recipient-address-input-placeholder-text-2' => '地址',
                    'address-qr-code-foot-text-1'                => '仅发送',
                    'amount-warning-text-1'                      => '提取/发送的金额必须至少为',
                    'amount-warning-text-2'                      => '请至少保留',
                    'amount-warning-text-3'                      => '网络费',
                    'amount-warning-text-4'                      => '加密交易可能需要一些时间才能完成',
                    'amount-allowed-decimal-text'                => '允许最多8位小数',
                ],
                'confirm' => [
                    'about-to-send-text-1' => '您即将发送',
                    'about-to-send-text-2' => '至',
                    'sent-amount'          => '寄出金额',
                    'network-fee'          => '网络费用',
                ],
                'success' => [
                    'sent-successfully' => '发送成功',
                    'amount-added'      => '金额将在之后添加',
                    'confirmations'     => '确认',
                    'address'           => '地址',
                    'again'             => '再次',
                ],
            ...
            'receive' => [
                'address-qr-code-head-text'   => '接收地址二维码',
                'address-qr-code-foot-text-1' => '只收到',
                'address-qr-code-foot-text-2' => '到这个地址',
                'address-qr-code-foot-text-3' => '收到任何其他硬币将导致永久损失',
                'address-input-label-text'    => '收货地址',
                'address-input-copy-text'     => '复制',
            ],
            'transactions' => [
            ...
            'preference-disabled' => '系统管理员已禁用加密货币',
        ],
    ],
    'express-payment'      => [
        'payment'           => '付款',
