<div class="box box-info box_info">
    <div class="panel-body">
        ...
        <ul class="nav navbar-pills nav-tabs nav-stacked no-margin" role="tablist">
            ...
            @if(Common::has_permission(\Auth::guard('admin')->user()->id, 'view_blockio_settings'))
                <li <?= $menu == 'blockio-settings' ? ' class="treeview active"' : 'treeview'?>>
                    <a href="{{ url('admin/settings/crypto-currencies-settings/BTC') }}">
                        <i class="fa fa-btc">
                        </i>
                        <span>
            ...
            @if(Common::has_permission(\Auth::guard('admin')->user()->id, 'view_sms_setting'))
                <li <?= $menu == 'sms' ? ' class="treeview active"' : 'treeview'?>>
                    <a href="{{ url('admin/settings/sms/twilio') }}">
            ...
            <li <?= $menu == 'notification-settings' ? ' class="treeview active"' : 'treeview'?>>
                <a href="{{ url('admin/settings/notification-types') }}">
                    <i class="fa fa-bell">
                    </i>
                    <span>
                        Notification Settings
